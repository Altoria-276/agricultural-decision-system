...
class RegressionPipeline:
    ...
    def plot_hessian_matrix(self):
        ...
        sns.heatmap(hessian_matrix, annot=False, fmt='.4f', xticklabels=self.features, yticklabels=self.features,
                    cmap='coolwarm', center=0, mask=np.tril(np.ones_like(hessian_matrix, dtype=bool)),
